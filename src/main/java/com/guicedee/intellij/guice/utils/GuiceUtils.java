...
public final class GuiceUtils {
  ...
  public static @Nullable String getScopeAnnotationForScopeExpression(PsiExpression arg) {
    ...
    if ("SINGLETON".equals(fieldName) && GuiceClasses.SCOPES.equals(className)) {
      return GuiceAnnotations.SINGLETON;
    }
    if ("REQUEST".equals(fieldName) && GuiceClasses.SERVLET_SCOPES.equals(className)) {
      return GuiceAnnotations.REQUEST_SCOPED;
    }
    if ("SESSION".equals(fieldName) && GuiceClasses.SERVLET_SCOPES.equals(className)) {
